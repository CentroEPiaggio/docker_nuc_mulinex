...
class Trajectory:
    ...
    def Direct_Kinematic(self, q, l, offset):
        ...
        # print(offset)
        Pos_EE = [
            l[0] * math.cos(q[0] + offset[0])
            + l[1] * math.cos(q[0] + offset[0] + q[1] + offset[1]),
            l[0] * math.sin(q[0] + offset[0])
            + l[1] * math.sin(q[0] + offset[0] + q[1] + offset[1]),
        ]
        # print(Pos_EE)
    ...
    def Trajectory_parabolic_IK(
        self, pos_init, pos_fin, time_ini, time_fin, time, l, offset, k_quadrante
    ):
