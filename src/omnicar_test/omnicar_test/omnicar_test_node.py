...
from pi3hat_moteus_int_msgs.msg import JointsCommand,JointsStates,PacketPass,OmniMulinexCommand,DistributorsState
...
class JumpingTest(Node):
    ...
    def homing_callback(self):  
        ...
        if(self.t < self.t_pre_test) and (self.state_moviment >= 0):
            ...
            self.publish_msg(height_rate = self.height_rate,v_x_init = self.v_x[0],v_x_fin = self.v_x[1],
                             ...
                             v_omega_init = self.omega[0],v_omega_fin = self.omega[1],
    ...
    def publish_msg(height_rate,v_x_init,v_x_fin,v_y_init,v_y_fin,omega_init,omega_fin,time_ini,time_fin,phase_test,phase_moviment): 
